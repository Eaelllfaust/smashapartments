...
export default function ManageRentalBookings() {
  return (
<>
  ...
  <section className="holder">
    ...
    <div className="intro_box">
      ...
      <div className="ibox">
        ...
        <Link to="/administrator/managebookings/deactivatedrentalsbookings" className="link">
          View all past bookings
        </Link>
      </div>
    </div>
    <div className="entry_1">
      <h2>Active rental bookings</h2>
    </div>
    <br />
