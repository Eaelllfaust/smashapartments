...
export default function ManageCoofficeBookings() {
  return (
    <>
      ...
      <section className="holder">
        ...
        <div className="intro_box">
          <div className="ibox">
            ...
            <p>There are 28 active cooffice bookings on Smash Apartments</p>
          </div>
          <div className="ibox">
            <div className="i2">
            ...
            <p>There are 13 legacy cooffice bookings on Smash Apartments</p>
            <Link to="/administrator/managebookings/deactivatedcoofficebookings" className="link">
              View all past bookings
            </Link>
          </div>
        </div>
        <div className="entry_1">
          <h2>Active cooffice bookings</h2>
        </div>
        <br />
