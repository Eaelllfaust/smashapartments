...
export default function ManageAirportPickups() {
  return (
    <>
      ...
      <section className="holder">
        ...
        <div className="intro_box">
          <div className="ibox">
            ...
            <p>There are 28 active pickup listings on smash apartments</p>
          </div>
          <div className="ibox">
            <div className="i2">
            ...
            <p>There are 13 deactived listings on smash apartments</p>
            <Link to="/administrator/managelistings/deactivatedpickups" className="link">
              View all inactive listings
            </Link>
          </div>
        </div>
        <div className="entry_1">
          <h2>Active pickup listings </h2>
        </div>
        <br />
        <br />
