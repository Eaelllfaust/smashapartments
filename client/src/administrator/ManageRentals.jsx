  ...
  <section className="holder">
    ...
    <div className="intro_box">
      <div className="ibox">
        ...
        <p>There are 28 active car rental listings on smash apartments</p>
      </div>
      <div className="ibox">
        <div className="i2">
        ...
        <p>There are 13 inactive listings on smash apartments</p>
        <Link to="/administrator/managelistings/deactivatedrentals" className="link">
          View all inactive listings
        </Link>
      </div>
    </div>
    <div className="entry_1">
      <h2>Active car rentals </h2>
    </div>
    <br />
    <br />
