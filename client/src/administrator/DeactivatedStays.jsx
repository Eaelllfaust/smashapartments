...
export default function DeactivatedStays() {
  return (
<>
  ...
  <section className="holder">
    ...
    <div className="intro_box">
      <div className="ibox">
        ...
        <p>There are 28 active stays listings on smash apartments</p>
        <Link to="/administrator/managelistings/managestayslistings" className="link">
