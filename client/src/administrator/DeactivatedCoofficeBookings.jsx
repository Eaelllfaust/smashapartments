...
export default function DeactivatedCoofficeBookings() {
  return (
    <>
    ...
    <section className="holder">
      ...
      <div className="intro_box">
        <div className="ibox">
          ...
          <Link to="/administrator/managebookings/managecoofficebookings" className="link">
