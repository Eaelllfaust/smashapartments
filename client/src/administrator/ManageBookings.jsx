...
export default function ManageBookings() {
  ...
  const fetchData = async () => {
    try {
      const [upcomingResponse, pastResponse, allBookingsResponse] = await Promise.all([
      ...
      <section className="holder">
        ...
        <div className="intro_box">
          <div className="ibox">
            ...
            <p>
              This is the number of upcoming bookings on the platform. That
              partners are responsible for changing their status.
            </p>
          </div>
          <div className="ibox">
            <div className="i2">
        ...
        <form onSubmit={handleSearch} style={{ display: "flex", alignItems: "center" }}>
          ...
          />
          <button type="submit" className="button b2 b3" style={{ borderRadius: 10, height: 50 }}>
            Search
          </button>
        </form>
        <br />
        ...
        <div key={booking._id} className="block_item service">
          ...
          <div className="row_item_2">
            ...
            <div>
              ...
              <i className="bx bx-copy take_me"></i>
            </div>
          </div>
          <br />
          <div className="row_item_2">
