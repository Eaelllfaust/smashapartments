...
export default function DeactivatedRentalsBookings() {
  return (
    <>
    ...
    <section className="holder">
      ...
      <div className="intro_box">
        <div className="ibox">
          ...
          <p>There are 28 active rental bookings on Smash Apartments</p>
          <Link to="/administrator/managebookings/managerentalbookings" className="link">
        ...
        <div className="ibox">
          ...
          <p>There are 13 legacy rental bookings on Smash Apartments</p>
        </div>
      </div>
      <div className="entry_1">
        <h2>Past rental bookings</h2>
      </div>
      <br />
      ...
      <div className="block_item">
        <div className="row_item_2">
          ...
          <div>
            ...
            <div className="light-text">12th to 23rd</div>
          </div>
        </div>
        <br />
        <div className="row_item_2">
