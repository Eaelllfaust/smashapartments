...
export default function ManageAirportBookings() {
  return (
    <>
    ...
    <section className="holder">
      ...
      <div className="intro_box">
        <div className="ibox">
          ...
          <p>There are 28 active pickup bookings on Smash Apartments</p>
        </div>
        <div className="ibox">
          <div className="i2">
          ...
          <p>There are 13 legacy pickup bookings on Smash Apartments</p>
          <Link to="/administrator/managebookings/deactivatedpickupbookings" className="link">
            View all past bookings
          </Link>
        </div>
      </div>
      <div className="entry_1">
        <h2>Active pickup bookings</h2>
      </div>
      <br />
