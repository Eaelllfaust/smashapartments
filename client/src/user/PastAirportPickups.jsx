...
export default function PastAirportPickups() {
  return (
    <>
    ...
    <section className="form_area2">
      <div className="ibox2">
        ...
        <p>This is the number of past pickups you've had: 1</p>
      </div>
      <div className="info">
        <div className="info_intro">
          ...
          <div className="info_data">
            ...
            <div className="info_2">Gary Julian</div>
          </div>
          <div className="info_data">
            <div className="info_1">Car details</div>
            <div className="info_2">Black, SUV</div>
          </div>
          <div className="info_data">
        ...
        <div className="info_second">
          ...
          <div className="link">View arrangement</div>
        </div>
      </div>
      <br />
      <br />
